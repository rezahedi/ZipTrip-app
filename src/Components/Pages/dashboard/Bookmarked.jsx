...
function Bookmarked() {
  ...
  // With a remove button to un-bookmark a plan
  // Plan list: GET /api/v1/account/bookmarks
  // Remove bookmark: DELETE /api/v1/account/bookmarks/:planId

  return <div>Bookmarked Plans</div>;
}
